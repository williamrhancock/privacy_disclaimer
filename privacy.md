...
- Your entries, presets, reminder settings, and voice notes are stored locally on your device.
- Voice notes are recorded and played back from your device only; the app stores file references, not cloud copies.
- The app does not send your data to a server or third-party analytics service.
- Notifications are optional and require your explicit permission. You can change notification settings at any time in your system Settings.
